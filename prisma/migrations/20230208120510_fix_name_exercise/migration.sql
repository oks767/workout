/*
  ...
  - You are about to drop the `Exersice` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_ExersiceToWorkout` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "_ExersiceToWorkout" DROP CONSTRAINT "_ExersiceToWorkout_A_fkey";

-- DropForeignKey
ALTER TABLE "_ExersiceToWorkout" DROP CONSTRAINT "_ExersiceToWorkout_B_fkey";

-- DropTable
DROP TABLE "Exersice";

-- DropTable
DROP TABLE "_ExersiceToWorkout";
